...
<html lang="en">
    ...
    <body class="bg-gray-950 font-['Cascadia_Mono']">
        ...
        <div class="flex items-center justify-center my-20 mx-10">
            ...
            <h1 class="mx-4 text-3xl font-bold text-white whitespace-nowrap">Sign up</h1>
            <div class="border-t-2 border-gray-700 flex-grow"></div>
        </div>

        <div class="flex justify-center">
            <!-- signup form -->
            <div class="bg-[#232120] w-xl p-6 rounded-lg">
                <form action="/register" method="POST">  
                    @csrf
                    <div class="flex items-center">
                        <label class="text-xl mr-22 text-white">Enter your name:</label>
                        <input type="text" name="name" id="name" class="bg-white rounded-xl p-2 mt-2 mb-5">
                    </div>
                    <div class="flex items-center">
                    ...
                    <div class="flex justify-end mt-3">
                        <button type="submit" id="submit" name="submit" class="p-3 mt-4 text-xl font-bold text-[#29dae4] hover:underline hover:underline-offset-8 hover:decoration-[#29dae4]">Sign up</button>
                    </div>
                </form>
            </div>
        </div>
